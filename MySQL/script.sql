...
CREATE USER 'roundcube'@'172.25.10.13'  IDENTIFIED BY '123@senha';
GRANT ALL PRIVILEGES ON roundcubemail.* TO 'roundcube'@'172.25.10.13';
FLUSH PRIVILEGES;
FLUSH TABLES;

CREATE DATABASE wordpress;
CREATE USER 'wordpress'@'172.25.10.50' IDENTIFIED BY '123@senha';
GRANT ALL PRIVILEGES ON wordpress.* TO 'wordpress'@'172.25.10.50';
FLUSH PRIVILEGES;
...
root@CARACAL:/var/www/html/SQL# 
root@CARACAL:/var/www/html/SQL# cat mysql.initial.sql 
-- Roundcube Webmail initial database structure
