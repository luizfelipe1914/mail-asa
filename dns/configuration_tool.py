...
ZONA_DIRETA = "./etc/zones-direct/db.mg.asa.br.external"
ZONA_REVERSA = "./etc/zones-reverse/db.reverso.mg.asa.br.external"
...
def main():
	...
	dz = replace_data_direct_zone(ZONA_DIRETA, js)
	rz = replace_data_reverse_zone(ZONA_REVERSA, js)
	write_data(dz, rz, ZONA_DIRETA, ZONA_REVERSA)
